...
c   compute LHS      
     ...
     &            aj,bj,cj,ak,bk,ck,jd,kd,jbeg,jend,kbeg,kend,im)
...
!am!am
!am!---- deallocate ----------
!am      deallocate(sjmat,sjmatb,bjmat)
!am      deallocate(aj,bj,cj)
!am      deallocate(ak,bk,ck)
!am      deallocate(vmul,vmulb)
!am      deallocate(vort,vortb,sn)
!am      deallocate(u,ub,v,vb)
!am      deallocate(s1,s2)
!am      deallocate(trip)
!am!am
...
c***********************************************************************
      ...
      !local variables
      !am real :: um(jd,kd),up(jd,kd),vm(jd,kd),vp(jd,kd)
...
60    continue
      ...
      !am deallocate
      !am ----------
      deallocate(chp,dnuhp)
      deallocate(dmxh,dmyh)
...
c***********************************************************************
     ...
     &                  aj,bj,cj,ak,bk,ck,jd,kd,js,je,ks,ke,im)
c***********************************************************************
      use params_global
c***********************************************************************
      implicit none
      integer jd,kd,js,je,ks,ke,im
      real q(jd,kd,nq), sjmat(jd,kd)
      real xx(jd,kd), xy(jd,kd), yx(jd,kd), yy(jd,kd)
      real aj(jd,kd),bj(jd,kd),cj(jd,kd)
      real ak(jd,kd),bk(jd,kd),ck(jd,kd)
