...
c***********************************************************************
      subroutine bctany(q,uwall,vwall,xx,xy,yx,yy,ug,vg,jd,kd,js,je,ks,ke,idir,invsc)
c
...
c..compute surface velocities
        ...
        !am call bctany(q,uwall,vwall,xx,xy,yx,yy,ug,vg,jd,kd,js,je,ks,ke,idir)
        call bctany(q,uwall,vwall,xx,xy,yx,yy,ug,vg,jd,kd,js,je,ks,ke,idir,invsc)
...
c..compute surface velocities
        ...
        !am call bctany(q,uwall,vwall,xx,xy,yx,yy,ug,vg,jd,kd,js,je,ks,ke,idir)
        !am call rbctany(q,s,duwall,dvwall,xx,xy,yx,yy,ug,vg,jd,kd,js,je,ks,ke,idir)
        call bctany(q,uwall,vwall,xx,xy,yx,yy,ug,vg,jd,kd,js,je,ks,ke,idir,invsc)
        call rbctany(q,s,duwall,dvwall,xx,xy,yx,yy,ug,vg,jd,kd,js,je,ks,ke,idir,invsc)
